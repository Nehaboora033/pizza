...
const Hero = () => {
  return (
    <div className='max-w-[1384px] mx-auto px-3 rounded-3xl bg-no-repeat bg-center bg-cover pl-[110px] pt-[127px] pb-[188px]' style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      <Button className={'pt-[16px] px-[32px] mr-6 '}>Order Now</Button>
      <Button className={'!border-white border !bg-none'}>View Full Menu</Button>
